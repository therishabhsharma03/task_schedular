...
function Taskform(props)
{
    ...
    return(
        <div style={{maxWidth:"40%",margin:"0px auto"}} class="container">
            ...
            <input defaultValue={props.labelValue} onChange={(event)=>setlabel(event.target.value)} class="contact--input" placeholder="Write a brief decription"/>
            <input defaultValue={props.dueDateValue} onChange={(event)=>setdueDate(event.target.value)} class="contact--input" placeholder="Due date"/>
